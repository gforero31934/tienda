...
public class Producto {
    ...
    public double calcularPrecioFinal() {
        ...
        double iva = darIVA();
        return valorUnitario * (1 + iva / 100);
    }
    ...
    public double darIVA() {
        ...
        //  supermercado, droguería y papelería.
        //  El IVA de cada tipo de producto es diferente, así:
        //  los productos de tipo supermercado tienen un IVA del 4%,
        //  los productos del tipo droguería tienen un IVA del 12% y
        //  los productos de tipo papelería tienen un IVA del 16%.
        double iva = 0.0;
        if (tipo.equals("supermercado")) {
            iva = 4.0; // IVA para productos de alimentación
        } else if (tipo.equals("drogueria")) {
            iva = 12.0; // IVA para productos electrónicos
        } else if (tipo.equals("papeleria")) {
            iva = 16.0; // IVA para ropa
        }
        return iva;
    }
    ...
    public int vender(int pCantidad) {
        if (pCantidad > 0) {
            if (pCantidad >= cantidadBodega) {
                int cantidadVendida = cantidadBodega;
                cantidadBodega = 0;
